...
End-to-end retail sales analytics project — messy transactional data cleaned in Excel/Power Query and PostgreSQL, analyzed with business KPIs, and visualized in an interactive Power BI report.
